...
let turnCompletePromise = new Promise((resolve) => {
  turnComplete = resolve;
});

async function* userMessages() {
  console.log(
    "Shopify agent ready. Type a message (Ctrl+C to quit).\n"
  );
  ...
  while (true) {
    ...
    turnCompletePromise = new Promise((resolve) => {
      turnComplete = resolve;
    });
  }
}
